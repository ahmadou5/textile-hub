...
export async function generateMetadata({
  ...
  return {
    title: inquiry
      ? `${inquiry.subject} — Wholesale | Maitangaran Textiles`
      : "Inquiry Not Found",
  };
}
...
export default async function WholesaleInquiryThreadPage({
  ...
  return (
    <div className="flex flex-col h-screen max-h-screen  ml-auto mr-auto overflow-hidden w-full max-w-4xl mx-auto space-y-6">
      {/* Back + Refresh */}
